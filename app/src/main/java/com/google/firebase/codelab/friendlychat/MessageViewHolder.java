...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindMessage(FriendlyMessage friendlyMessage) {
        if (friendlyMessage.getText() != null) {
            ...
            dateTimeTextView.setText(friendlyMessage.getDateTimeString());
            dateTimeTextView.setVisibility(TextView.VISIBLE);
            ...
            messengerTextView.setVisibility(TextView.GONE);
            dateTimeTextView.setVisibility(TextView.GONE);
        }
    }
}